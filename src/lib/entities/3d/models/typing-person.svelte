...
Command: npx @threlte/gltf@2.0.3 /home/noir/Desktop/Projects/personal-webpage-front/static/models/man-typing.glb --root /models/ --printwidth 120 --precision 2
-->
		...
		<T.Group name="Scene">
			<T.Group name="Armature" rotation={[-Math.PI, 0, 0]} scale={-1}>
				...
				<T.Group name="glasses">
					...
					<T.SkinnedMesh
						...
						material={gltf.materials.glasses}
						skeleton={gltf.nodes.mesh001_1.skeleton}
					/>
				</T.Group>
				<T.SkinnedMesh
					name="hair"
			...
			<T.Group name="laptop">
				<T.Mesh
					...
					material={gltf.materials.laptop}
				/>
				<T.Mesh
					name="Cube002_1"
			...
			<T.Group name="table">
				<T.Mesh
					...
					material={gltf.materials.table_wood}
				/>
				<T.Mesh
					name="Cube003_1"
					geometry={gltf.nodes.Cube003_1.geometry}
					material={gltf.materials.table_legs}
				/>
			</T.Group>
		</T.Group>
	{:catch error}
